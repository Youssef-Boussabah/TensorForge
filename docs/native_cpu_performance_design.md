...
(§16.7). H8 has now shipped too (§16.8), and it is where the composed
normalization cost was finally addressed — from the elementwise side,
which is what the evidence supported. The conditional slots after it
keep their numbers.
