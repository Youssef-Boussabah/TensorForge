...
## Phase H — native CPU performance and runtime efficiency, **begun (H0–H3)**

**Phase H is the current phase. It has begun, and milestones H0, H1,
H2, and H3 are complete.**
...
registry, no dtype, no device, and no checkpoint format; H1, H2, and H3
moved no capability either. `UNSUPPORTED` still reads
...
| H4–H8 | **Proposals, not commitments.** Ordered by measured leverage and each explicitly conditional: a milestone whose premise the preceding measurement does not confirm is narrowed, reordered, or dropped, and the reason is recorded in the design | **Not started** |
