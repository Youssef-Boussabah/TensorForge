...
## Phase H — native CPU performance and runtime efficiency, **begun (H0–H5)**

**Phase H is the current phase. It has begun, and milestones H0, H1,
H2, H3, H4, and H5 are complete.**
...
H4, and H5 moved no capability either. `UNSUPPORTED` still reads
...
| H6–H11 | **Proposals, not commitments.** Ordered by measured leverage and each explicitly conditional: a milestone whose premise the preceding measurement does not confirm is narrowed, reordered, or dropped, and the reason is recorded in the design. H5 is the worked example — the ladder really was reordered, moving reduction execution from the H5 slot to H6 on H4's evidence | **Not started** |
