...
# The unavailable-backend contract for `softmax` — ImportError with build
# instructions, never a silent NumPy fallback — is proved in
# tests/test_native_backend_unavailable.py (the "softmax" case). It used
# to live here and skip whenever the backend was built, which is every
