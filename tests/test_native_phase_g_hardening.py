...
def test_this_milestone_wrote_no_result_artifact():
    """G6 itself produced no artifact of any kind. (G7's example, G8's
    benchmark, and G9's integration suite all exist — later milestones
    shipped them; this suite is not where their absence is asserted, and
    G8's harness writes no file unless asked.)"""
