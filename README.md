...
- The native CNN stack (Phase D), the native classification stack
  ...
  no runtime for it exists yet, and none will until J1.) Native checkpoints capture
...
runtime API is exported yet**; runtime capability begins at **J1**. What J0
shipped is
