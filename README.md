...
landed, and J8 through J9 have not started.** Phase J was approved *after*
...
**No automatic loader discovery exists in either direction**, and there is
no benchmark; that is **J8, which is next**. What J0 shipped is
