...
closed at I11 rather than having been on the earlier roadmap. **J0 was
...
example, benchmark, or schema change. **The sampler and the loader do not
exist yet**, so there is still no shuffling, no epoch or cursor, no loader
state, and **no native mini-batching**; those begin at **J2, which is
