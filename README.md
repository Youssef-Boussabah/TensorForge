...
landed, and J9 has not started.** Phase J was approved *after*
...
phase closure — the full validation matrix, the sanitizer runs, and the
closure guardrails — is **J9, which is next**. What J0 shipped is
